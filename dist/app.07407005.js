...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./apis/climacell":"js/apis/climacell.js","../pages/assets/icons/*.svg":"pages/assets/icons/*.svg"}],"pages/left/js/app.js":[function(require,module,exports) {
"use strict";
...
var setLeftData = function setLeftData(realtime, dayInfo) {
  // set temp
  document.querySelector('#now h2.temp').innerHTML = "".concat(Math.round(realtime.temperature), "\u02DA"); // set feels like temp

  document.querySelector('#now .subh .temp').innerHTML = "".concat(Math.round(realtime.temperatureApparent), "\u02DA"); // set weather description

  document.querySelector('#now h3').innerHTML = _constants.WEATHER_CONDITIONS[realtime.weatherCode]; // set icon and background

  var daypart = (0, _weatherApi.getDaypart)(new Date(), new Date(dayInfo.sunriseTime).getTime(), new Date(dayInfo.sunsetTime).getTime()); // console.log(daypart);

  document.querySelector('#now img').src = _weatherApi.icons[(0, _weatherApi.parseWeatherCode)(realtime.weatherCode, daypart)];
  document.querySelector('#now').classList = "".concat(daypart, " tri");
};
...
function _ready() {
  _ready = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var stationInfo, lastUpdatedLeft, leftData, stationID, dayData, newLeftData, timelines, realtimeData;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stationInfo = (0, _board.getStationInfo)(); // set current time

            document.querySelector('#now .time').innerHTML = (0, _app.getCurrentTime)(); // get cache

            lastUpdatedLeft = localStorage.getItem('lastUpdatedLeft');
            leftData = JSON.parse(localStorage.getItem('leftData'));
          ...
          case 8:
            ...
            if (!(!leftData || stationID !== stationInfo.id || Date.now() - lastUpdatedLeft * 1 > _constants.REALTIME_INTERVAL)) {
              _context.next = 17;
              break;
            }

            _context.next = 12;
            return (0, _weatherApi.getWeatherData)(stationInfo.lat, stationInfo.lon, _climacell.API_TYPE.LEFT);

          case 12:
            newLeftData = _context.sent;
            // console.log('left => ', data);
            timelines = newLeftData.timelines;

            if (timelines) {
              realtimeData = timelines[0].intervals[0].values;
              setLeftData(realtimeData, dayData);
              localStorage.setItem('leftData', JSON.stringify({
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","../../../js/apis/climacell.js":"js/apis/climacell.js","../../../js/app.js":"js/app.js","../../../js/constants":"js/constants.js","../../../js/board.js":"js/board.js","../../../js/weatherApi":"js/weatherApi.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","pages/left/js/app.js"], null)
//# sourceMappingURL=/app.07407005.js.map