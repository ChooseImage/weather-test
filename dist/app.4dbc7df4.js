...
},{"./constants":"js/constants.js","../data/transit/mta-geo.json":"data/transit/mta-geo.json","../data/transit/mbta-geo.json":"data/transit/mbta-geo.json","../data/transit/lirr-geo.json":"data/transit/lirr-geo.json","../data/transit/mnr-geo.json":"data/transit/mnr-geo.json","../data/transit/others.json":"data/transit/others.json","./apis/climacell":"js/apis/climacell.js"}],"pages/right/js/app.js":[function(require,module,exports) {
"use strict";

require("regenerator-runtime/runtime");

var _climacell = require("../../../js/apis/climacell.js");
...
var setRealtimeData = function setRealtimeData(realtime) {
  // set humidity
  document.querySelector('#humidity').innerHTML = "".concat(Math.round(realtime.humidity), "%"); // set wind data

  document.querySelector('#wind').innerHTML = "".concat(Math.round(realtime.windSpeed), " MPH ").concat((0, _app.degToDir)(realtime.windDirection)); // set uv index

  document.querySelector('#uv-index').innerHTML = "".concat(realtime.uvIndex, " ").concat((0, _app.getUVIndex)(+realtime.uvIndex)); // set air quality

  document.querySelector('#air-quality').innerHTML = "".concat(realtime.epaIndex, " ").concat(_constants.AIR_QUALITY[+realtime.epaHealthConcern]);
};

var setForecastData = function setForecastData(forecast) {
  var idx = (0, _weatherApi.getForecastIndex)(forecast[0].startTime) + 2; // set temp

  document.querySelector('#forecast-2 h2.temp').innerHTML = "".concat(Math.round(forecast[idx].values.temperature), "\u02DA"); // set feels like temp

  document.querySelector('#forecast-2 .subh .temp').innerHTML = "".concat(Math.round(forecast[idx].values.temperatureApparent), "\u02DA"); // set weather description

  document.querySelector('#forecast-2 h3').innerHTML = _constants.WEATHER_CONDITIONS[forecast[idx].values.weatherCode]; // set forecast time

  document.querySelector('#forecast-2 h2.time').innerHTML = (0, _weatherApi.getForecastTime)(forecast[idx].startTime);
};

var setDayData = function setDayData(forecast, dayInfo) {
  // set sunrise/sunset info
  var sunriseTime = new Date(dayInfo.sunriseTime).getTime();
  var sunsetTime = new Date(dayInfo.sunsetTime).getTime();
  var sunInfo = (0, _weatherApi.getSunTime)(dayInfo.sunriseTime, dayInfo.sunsetTime);
  document.querySelector('#sun-title').innerHTML = sunInfo.title;
  document.querySelector('#sun-time').innerHTML = sunInfo.time; // set icon and background

  var idx = (0, _weatherApi.getForecastIndex)(forecast[0].startTime) + 2;
  var daypart = (0, _weatherApi.getDaypart)(new Date(forecast[idx].startTime), sunriseTime, sunsetTime);
  document.querySelector('#forecast-2 img').src = _weatherApi.icons[(0, _weatherApi.parseWeatherCode)(forecast[idx].values.weatherCode, daypart)];
  document.querySelector('#forecast-2').classList = "".concat(daypart, " tri");
};
...
function _ready() {
  _ready = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var stationInfo, lastUpdatedRight, rightData, stationID, dayData, newRightData, timelines, tCurrent, t1h, realtimeData, forecastData;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stationInfo = (0, _board.getStationInfo)(); // get cache

            lastUpdatedRight = localStorage.getItem('lastUpdatedRight');
            rightData = JSON.parse(localStorage.getItem('rightData'));
          ...
          case 7:
            ...
            if (!(!rightData || stationID !== stationInfo.id || Date.now() - lastUpdatedRight * 1 > _constants.FORECAST_INTERVAL)) {
              _context.next = 16;
              break;
            }

            _context.next = 11;
            return (0, _weatherApi.getWeatherData)(stationInfo.lat, stationInfo.lon, _climacell.API_TYPE.RIGHT);

          case 11:
            newRightData = _context.sent;
            // console.log('right => ', data);
            timelines = newRightData.timelines;
            ...
            if (timelines) {
              ...
              forecastData = t1h.intervals;
              setRealtimeData(realtimeData);
              setForecastData(forecastData);
              setDayData(forecastData, dayData);
              localStorage.setItem('rightData', JSON.stringify({
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","../../../js/apis/climacell.js":"js/apis/climacell.js","../../../js/app.js":"js/app.js","../../../js/constants":"js/constants.js","../../../js/weatherApi":"js/weatherApi.js","../../../js/board.js":"js/board.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","pages/right/js/app.js"], null)
//# sourceMappingURL=/app.4dbc7df4.js.map