...
},{"./apis/climacell":"js/apis/climacell.js","./constants":"js/constants.js"}],"data/transit/mta-geo.json":[function(require,module,exports) {
module.exports = [{
  "Station ID": 1,
  "Complex ID": 1,
  "GTFS Stop ID": "R01",
...
},{"./constants":"js/constants.js","../data/transit/mta-geo.json":"data/transit/mta-geo.json","../data/transit/mbta-geo.json":"data/transit/mbta-geo.json","../data/transit/lirr-geo.json":"data/transit/lirr-geo.json","../data/transit/mnr-geo.json":"data/transit/mnr-geo.json","../data/transit/others.json":"data/transit/others.json","./apis/climacell":"js/apis/climacell.js"}],"pages/assets/icons/1000_day.svg":[function(require,module,exports) {
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./apis/climacell":"js/apis/climacell.js","../pages/assets/icons/*.svg":"pages/assets/icons/*.svg"}],"js/debug.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(bool) {
  ...
  dEl.id = 'debug';
  document.body.appendChild(dEl); // save the original console.log function

  var old_logger = console.log; // grab html element for adding console.log output

  var html_logger = document.getElementById('debug'); // replace console.log function with our own function

  console.log = function (msg) {
    // first call old logger for console output
    old_logger.call(this, arguments); // check what we need to output (object or text) and add it to the html element.

    if (_typeof(msg) == 'object') {
      html_logger.innerHTML += '<p>' + (JSON && JSON.stringify ? JSON.stringify(msg) : msg) + '</p>';
    } else {
...
},{}],"pages/vup/js/app.js":[function(require,module,exports) {
"use strict";
...
var _debug = _interopRequireDefault(require("../../../js/debug.js"));
...
var setRealtimeData = function setRealtimeData(realtime, dayInfo) {
  ...
  var sunInfo = (0, _weatherApi.getSunTime)(dayInfo.sunriseTime, dayInfo.sunsetTime); // set icon and background

  var daypart = (0, _weatherApi.getDaypart)(new Date(), sunriseTime, sunsetTime); // console.log(daypart);

  document.querySelector('#forecast img').src = _weatherApi.icons[(0, _weatherApi.parseWeatherCode)(realtime.weatherCode, daypart)];
  document.querySelector('#now').classList = daypart;
  document.querySelector('#forecast h2.temp').innerHTML = "".concat(Math.round(realtime.temperature), "\u02DA"); // set feels like temp

  document.querySelector('#forecast .subh .temp').innerHTML = "".concat(Math.round(realtime.temperatureApparent), "\u02DA"); // set weather description

  document.querySelector('#forecast h3').innerHTML = _constants.WEATHER_CONDITIONS[realtime.weatherCode];
};
...
function _ready() {
  _ready = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var stationInfo, lastUpdatedVup, vupData, stationID, title, dayData, newVupData, timelines, realtimeData;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // debug(true);
            stationInfo = (0, _board.getStationInfo)(); // set date
            ...
            lastUpdatedVup = localStorage.getItem('lastUpdatedVup');
            vupData = JSON.parse(localStorage.getItem('vupData'));
            stationID = localStorage.getItem('stationID');
            title = document.querySelector('#station-title');
            title.innerHTML = stationInfo && stationInfo.name;
            if (stationInfo && stationInfo.name.length > 26) title.classList.add('long-text');
            _context.prev = 8;
            _context.next = 11;
          ...
          case 11:
            ...
            if (!(!vupData || stationID !== stationInfo.id || Date.now() - lastUpdatedVup * 1 > _constants.REALTIME_INTERVAL)) {
              _context.next = 20;
              break;
            }

            _context.next = 15;
            return (0, _weatherApi.getWeatherData)(stationInfo.lat, stationInfo.lon, _climacell.API_TYPE.VUP);

          case 15:
            newVupData = _context.sent;
            timelines = newVupData.timelines;

            if (timelines) {
              realtimeData = timelines[0].intervals[0].values;
              setRealtimeData(realtimeData, dayData);
              localStorage.setItem('vupData', JSON.stringify({
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","pages/vup/js/app.js"], null)
//# sourceMappingURL=/app.5bf93e24.js.map