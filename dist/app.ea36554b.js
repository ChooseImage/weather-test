...
},{}],"data/transit/mta-geo.json":[function(require,module,exports) {
module.exports = [{
  "Station ID": 1,
  "Complex ID": 1,
  "GTFS Stop ID": "R01",
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./apis/climacell":"js/apis/climacell.js","../pages/assets/icons/*.svg":"pages/assets/icons/*.svg"}],"js/app.js":[function(require,module,exports) {
"use strict";
...
},{"./apis/climacell":"js/apis/climacell.js","./constants":"js/constants.js"}],"pages/center/js/app.js":[function(require,module,exports) {
"use strict";
...
var setCenterData = function setCenterData(forecast, dayInfo) {
  var idx = (0, _weatherApi.getForecastIndex)(forecast[0].startTime); // set temp

  document.querySelector('#forecast-1 h2.temp').innerHTML = "".concat(Math.round(forecast[idx].values.temperature), "\u02DA"); // set feels like temp

  document.querySelector('#forecast-1 .subh .temp').innerHTML = "".concat(Math.round(forecast[idx].values.temperatureApparent), "\u02DA"); // set weather description

  document.querySelector('#forecast-1 h3').innerHTML = _constants.WEATHER_CONDITIONS[forecast[idx].values.weatherCode]; // set forecast time

  document.querySelector('#forecast-1 h2.time').innerHTML = (0, _weatherApi.getForecastTime)(forecast[idx].startTime); // set icon and background

  var daypart = (0, _weatherApi.getDaypart)(new Date(forecast[idx].startTime), new Date(dayInfo.sunriseTime).getTime(), new Date(dayInfo.sunsetTime).getTime());
  document.querySelector('#forecast-1 img').src = _weatherApi.icons[(0, _weatherApi.parseWeatherCode)(forecast[idx].values.weatherCode, daypart)];
  document.querySelector('#forecast-1').classList = "".concat(daypart, " tri");
};
...
function _ready() {
  _ready = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var stationInfo, lastUpdatedCenter, centerData, stationID, dayData, newCenterData, timelines, forecastData;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stationInfo = (0, _board.getStationInfo)();
            document.querySelector('#station-title').innerHTML = stationInfo.name; // set date
            ...
            lastUpdatedCenter = localStorage.getItem('lastUpdatedCenter');
            centerData = JSON.parse(localStorage.getItem('centerData'));
          ...
          case 9:
            ...
            if (!(!centerData || stationID !== stationInfo.id || Date.now() - lastUpdatedCenter * 1 > _constants.FORECAST_INTERVAL)) {
              _context.next = 18;
              break;
            }

            _context.next = 13;
            return (0, _weatherApi.getWeatherData)(stationInfo.lat, stationInfo.lon, _climacell.API_TYPE.CENTER);

          case 13:
            newCenterData = _context.sent;
            // console.log('center => ', data);
            timelines = newCenterData.timelines;

            if (timelines) {
              forecastData = timelines[0].intervals;
              setCenterData(forecastData, dayData);
              localStorage.setItem('centerData', JSON.stringify({
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","../../../js/apis/climacell.js":"js/apis/climacell.js","../../../js/constants":"js/constants.js","../../../js/board.js":"js/board.js","../../../js/weatherApi":"js/weatherApi.js","../../../js/app.js":"js/app.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","pages/center/js/app.js"], null)
//# sourceMappingURL=/app.ea36554b.js.map